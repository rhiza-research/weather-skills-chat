...
app.state.config.RENDERING_PROMPT = RENDERING_PROMPT
...
app.state.config.EMAIL_TOOL_SMTP_HOST = EMAIL_TOOL_SMTP_HOST
app.state.config.EMAIL_TOOL_SMTP_PORT = EMAIL_TOOL_SMTP_PORT
app.state.config.EMAIL_TOOL_SMTP_USERNAME = EMAIL_TOOL_SMTP_USERNAME
app.state.config.EMAIL_TOOL_SMTP_PASSWORD = EMAIL_TOOL_SMTP_PASSWORD
app.state.config.EMAIL_TOOL_SMTP_USE_TLS = EMAIL_TOOL_SMTP_USE_TLS
app.state.config.EMAIL_TOOL_FROM_EMAIL = EMAIL_TOOL_FROM_EMAIL
...
async def get_app_latest_release_version(user=Depends(get_verified_user)):
    # This fork is not Open WebUI; never check upstream releases.
...
async def get_manifest_json():
    if app.state.EXTERNAL_PWA_MANIFEST_URL:
        ...
        return {
            ...
            "description": "Weather Skills — download and view forecasts and observational data.",
            "start_url": "/",
            "display": "standalone",
