...
ARTIFACTS_DIR = Path(
    os.getenv("ARTIFACTS_DIR", Path(DATA_DIR) / "artifacts")
).resolve()
...
# Optional 32-byte key (hex or base64) for AES-256-GCM secret storage.
# If unset, a key is generated once at DATA_DIR/secret_store.key.
